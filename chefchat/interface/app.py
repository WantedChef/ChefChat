...
class ChefChatApp(App):
    ...
    async def _initialize_agent(self) -> None:
        ...
        try:
            ...
            # Refresh Footer
            try:
                 self.query_one("#kitchen-footer", KitchenFooter).refresh_model(self._config.active_model)
            except Exception:
                 pass
    ...
    def _on_onboarding_complete(self, provider: str | None) -> None:
        ...
        self.call_after_refresh(
            lambda: self.push_screen(ModelManagerScreen(self._config or VibeConfig.load()), on_manager_closed)
        )
    ...
    def compose(self) -> ComposeResult:
        ...
        yield KitchenFooter(self._mode_manager, active_model=active_model, id="kitchen-footer")
        yield CommandInput(
        ...
        def on_model_selected(model_alias: str | None) -> None:
            if model_alias and self._config:
                try:
                    ...
                    self.query_one("#kitchen-footer", KitchenFooter).refresh_model(model_alias)
