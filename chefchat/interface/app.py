...
class ChefChatApp(App):
    ...
    def __init__(self, layout: TUILayout = TUILayout.CHAT_ONLY) -> None:
        super().__init__()
...
def run(*, verbose: bool = False, layout: str | None = None) -> None:
    ...
    while True:
        ...
        app = ChefChatApp(layout=layout_mode)
