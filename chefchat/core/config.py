...
DEFAULT_MODELS = [
    ...
    # =========================================================================
    # OpenRouter Models - Access 100+ models with one API key
    # =========================================================================
    ModelConfig(
        ...
        max_tokens=8192,
        multimodal=True,
        features={"reasoning", "coding", "vision", "tool_use"},
    ),
    ModelConfig(
        ...
        output_price=4.0,
        max_tokens=8192,
        features={"speed", "coding", "tool_use"},
    ),
    ModelConfig(
        name="openai/gpt-4o",
        provider="openrouter",
        ...
        max_tokens=16384,
        multimodal=True,
        features={"reasoning", "vision", "coding", "tool_use"},
    ),
    ModelConfig(
        ...
        max_tokens=16384,
        multimodal=True,
        features={"speed", "vision", "coding", "tool_use"},
    ),
    ModelConfig(
    ...
    ModelConfig(
        ...
        output_price=0.28,
        max_tokens=8192,
        features={"coding", "reasoning", "cost_effective"},
    ),
    ModelConfig(
        ...
        output_price=0.28,
        max_tokens=16384,
        features={"coding", "tool_use", "cost_effective"},
    ),
    ModelConfig(
        ...
        output_price=0.16,
        max_tokens=32768,
        features={"coding", "large_context", "cost_effective"},
    ),
    ModelConfig(
        ...
        output_price=0.39,
        max_tokens=8192,
        features={"versatile", "open_source", "tool_use"},
    ),
    ModelConfig(
