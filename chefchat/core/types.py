...
AsyncApprovalCallback = Callable[
    [str, dict[str, Any], str], Awaitable[tuple[str, str | None]]
]

SyncApprovalCallback = Callable[[str, dict[str, Any], str], tuple[str, str | None]]

ApprovalCallback = AsyncApprovalCallback | SyncApprovalCallback
