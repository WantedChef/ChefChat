...
from chefchat.acp.tools.base import BaseAcpTool
from chefchat.acp.tools.session_update import (
    tool_call_session_update,
    tool_result_session_update,
)
from chefchat.acp.utils import TOOL_OPTIONS, ToolOption, VibeSessionMode
    ...
    async def newSession(self, params: NewSessionRequest) -> NewSessionResponse:
        ...
        try:
            config = VibeConfig.load(
                ...
                tool_paths=[str(CHEFCHAT_ROOT / "acp" / "tools" / "builtins")],
